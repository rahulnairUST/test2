		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comhpehpeproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comhpehpeproject-display": {
								"semanticObject": "comhpehpeproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.hpe.hpeproject",
									"url": sap.ui.require.toUrl("com/hpe/hpeproject")
								}
							}
						}
					}
